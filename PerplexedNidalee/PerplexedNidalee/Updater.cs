...
namespace PerplexedNidalee
{
    class Updater
    {
        ...
        {
            return new BetterWebClient(null).DownloadString("https://raw.githubusercontent.com/Perplexity/LeagueSharp/master/PerplexedNidalee/PerplexedNidalee/version/version.txt");
        }
    }
}
